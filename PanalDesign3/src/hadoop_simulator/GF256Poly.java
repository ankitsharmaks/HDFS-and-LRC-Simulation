...
final class GF256Poly {
  ...
  //   System.out.println("This is reminders"+remainder);
    

    int denominatorLeadingTerm = other.getCoefficient(other.getDegree());
//  System.out.println("This is denominatorLeadingTerm"+denominatorLeadingTerm);
    
    int inverseDenominatorLeadingTerm = field.inverse(denominatorLeadingTerm);
    //    System.out.println("This is inverseDenominatorLeadingTerm"+inverseDenominatorLeadingTerm);
    
    
    while (remainder.getDegree() >= other.getDegree() && !remainder.isZero()) {
      int degreeDifference = remainder.getDegree() - other.getDegree();
 //    System.out.println("This is degreeDifference"+degreeDifference);
